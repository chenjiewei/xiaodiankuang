package chiyu.cjw.com.chiyu.ui.mainui.mycollection;
...
/**
 * Created: chnejiewei
 * data: 2016/9/10 22:06
 * blog: http://blog.csdn.net/u010392352
 * weibo：C-Xstart
 * description:
 */
public class HomeMyCollectionFragment extends BaseFragment {
    protected void eventBusThread(EventBusBean paramEventBusBean) {
    }

    protected int initLayout() {
        return R.layout.cy_home_collection_fragment;
    }
