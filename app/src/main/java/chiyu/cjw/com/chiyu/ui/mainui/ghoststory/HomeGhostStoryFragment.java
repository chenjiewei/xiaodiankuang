package chiyu.cjw.com.chiyu.ui.mainui.ghoststory;
...
/**
 * Created: chnejiewei
 * data: 2016/9/10 20:48
 * blog: http://blog.csdn.net/u010392352
 * weibo：C-Xstart
 * description:
 */
public class HomeGhostStoryFragment extends BaseFragment {
    protected void eventBusThread(EventBusBean paramEventBusBean) {
    }

    protected int initLayout() {
        return R.layout.cy_home_ghost_fragment;
    }
